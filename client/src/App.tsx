...
function App() {
  ...
  useEffect(() => {
    const checkJwtToken = async () => {
      const response:Response = await fetch(
        "https://personal-library-server.onrender.com/users/accessToken", {
        method: "GET",
        credentials: "include",
        headers: {
  ...
  useEffect(() => {
    const getCsrfToken = async () => {
      const response = await fetch(
        "https://personal-library-server.onrender.com/users/csrf-token", {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-Type": "application/json"
  ...
  useEffect(() => {
    const verifyUser = async () => {
      await fetch(
        "https://personal-library-server.onrender.com/users/refreshToken", {
        method: "POST",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
